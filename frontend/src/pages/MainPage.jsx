...
function MainPage() {
  ...
  return (
    <main className="main-page">
      <section ref={heroRef} className="hero" style={{ backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.7), rgba(0, 0, 0, 0.7)), url(${heroImage})` }}>
